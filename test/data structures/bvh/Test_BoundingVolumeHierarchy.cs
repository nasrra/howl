...
{    
    ...
    public void Clear_Test()
    {
        ...
        {            
            ...
            {
                Soa_Leaf.Append(bvh.Leaves, 0,0,0,0,0,0,0);
    ...
    public void ConstructTree_Test()
    {
        ...
        for(int q = 0; q < 2; q++)
        {
            ...
            Soa_Leaf.Append(bvh.Leaves, minX0, minY0, maxX0, maxY0, centroidX0, centroidY0, cat0);
            ...
            Soa_Leaf.Append(bvh.Leaves, minX1, minY1, maxX1, maxY1, centroidX1, centroidY1, cat1);
            ...
            Soa_Leaf.Append(bvh.Leaves, minX2, minY2, maxX2, maxY2, centroidX2, centroidY2, cat2);
            ...
            Soa_Leaf.Append(bvh.Leaves, minX3, minY3, maxX3, maxY3, centroidX3, centroidY3, cat3);
            ...
            Soa_Leaf.Append(bvh.Leaves, minX4, minY4, maxX4, maxY4, centroidX4, centroidY4, cat4);
    ...
    //         Soa_Leaf.Append(bvh.Leaves, minX, minY, maxX, maxY, centroidX, centroidY, cat);
    //     }        
    ...
    public void RaycastQuery_Test()
    {
        ...
        int leaf1Cat = 0;
        Soa_Leaf.Append(bvh.Leaves, leaf1AABB.MinX, leaf1AABB.MinY, leaf1AABB.MaxX, leaf1AABB.MaxY, leaf1Centroid.X, leaf1Centroid.Y, leaf1Cat);

        // leaf 2
        Aabb leaf2AABB = new Aabb(10,10,20,20);
        Vector2 leaf2Centroid = Aabb.CalculateCentroid(leaf2AABB);
        int leaf2Cat = 1;
        Soa_Leaf.Append(bvh.Leaves, leaf2AABB.MinX, leaf2AABB.MinY, leaf2AABB.MaxX, leaf2AABB.MaxY, leaf2Centroid.X, leaf2Centroid.Y, leaf2Cat);
