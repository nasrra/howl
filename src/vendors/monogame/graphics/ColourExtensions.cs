...
public static class ColourExtensions
{
    ...
    public static Howl.Graphics.Colour ToHowl(this Microsoft.Xna.Framework.Color color)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Microsoft.Xna.Framework.Color ToMonoGame(this Howl.Graphics.Colour color)
    {
        return new (color.R, color.G, color.B, color.A);
    }
}