...
public static class RectangleExtensions
{
    ...
    public static Howl.Math.Rectangle ToHowl(this Microsoft.Xna.Framework.Rectangle rectangle)
    {   
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Microsoft.Xna.Framework.Rectangle ToMonoGame(this Howl.Math.Rectangle rectangle)
    {
