...
public static class Vector2Extensions
{
    ...
    public static Howl.Math.Vector2 ToHowl(this Microsoft.Xna.Framework.Vector2 vector) => new(vector.X, vector.Y);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Microsoft.Xna.Framework.Vector2 ToMonogame(this Howl.Math.Vector2 vector) => new(vector.X, vector.Y);
}