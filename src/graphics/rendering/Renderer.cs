...
public static bool SetSpriteActive(
    SpriteId spriteId, bool isActive
){
    return WebGPU.Renderer.SetSpriteActive(ref GlobalState.WebGpuCtx, spriteId, isActive);
}
...
/**##########################################################################################################################################
    div start: Final Render Texture. 
##########################################################################################################################################**/
