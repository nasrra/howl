...
public unsafe struct CollisionNew
{
    /// <summary>
    /// A comparer to sort collisions in an ascending order in relation to the owners index.
    /// </summary>
    public static Comparer<CollisionNew> AscendingOwnerIndexComparer = Comparer<CollisionNew>.Create((a, b) => a.OwnerIndex.CompareTo(b.OwnerIndex));
    ...
    public static void SetContactPoints(ref CollisionNew collision, Span<float> xContactPoints, Span<float> yContactPoints)
    {
