...
public static class Keyboard
{
    ...
    public static bool IsKeyDown(HowlAppState app, Key key)
    {
    ...
    public static bool IsKeyUp(HowlAppState app, Key key)
    {
        Microsoft.Xna.Framework.Input.Keys keys = Vendors.MonoGame.Input.KeyExtensions.ToMonoGame(key);
    ...
    public static bool IsKeyJustPressed(HowlAppState app, Key key)
    {
        Microsoft.Xna.Framework.Input.Keys keys = Vendors.MonoGame.Input.KeyExtensions.ToMonoGame(key);
    ...
    public static bool IsKeyJustReleased(HowlAppState app, Key key)
    {
        Microsoft.Xna.Framework.Input.Keys keys = Vendors.MonoGame.Input.KeyExtensions.ToMonoGame(key);
